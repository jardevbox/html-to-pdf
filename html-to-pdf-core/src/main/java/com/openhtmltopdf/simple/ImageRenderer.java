 ...
 * for rendering a {@link File}, {@link #renderToImage(File,String)}</p>
 *
...
public class ImageRenderer {
	 ...
	 *
	 * @throws IOException if the input URL, or output path location is invalid
	 */
	 ...
	 *
	 * @param args see desc
	 * @throws IOException if source could not be read, or if image path is invalid
	 */
