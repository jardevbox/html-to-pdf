 ...
 * {@link ImageUtil#getScaledInstance(ScalingOptions,Image)}.
...
public class ScalingOptions {
	...
	/**
	 * Returns a Map of image rendering hints applicable to {@link Graphics2D#setRenderingHints(Map)}.
