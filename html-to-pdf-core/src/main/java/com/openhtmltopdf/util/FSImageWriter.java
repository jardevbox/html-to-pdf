 ...
 * thus controlled. Uses the java ImageIO libraries--see {@link ImageIO} and related classes,
 * especially {@link ImageWriter}.</p>
 * <p/>
 ...
 * </pre>
 * <p/>
 * <p>You can set the image format in the constructore ({@link FSImageWriter#FSImageWriter(String)},
...
public class FSImageWriter {
     ...
     * {@link ImageWriteParam#setCompressionQuality(float)} for a description of what this means
     ...
     * {@link ImageWriteParam#setCompressionMode(int)}  for a description of what this means
     * and valid range of values.
     *
     ...
     * {@link ImageWriteParam#setCompressionType(String)} for a description of what this means
     * and valid range of values.
     *
