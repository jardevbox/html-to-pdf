...
public class Java2DRenderer {
	 ...
	 * {@link Graphics2D#setRenderingHints(Map)}. The Map need not specify values for all
	 ...
	 * {@link BufferedImage} allowed in that class' constructor as a type argument. See docs for
	 * the type parameter in {@link BufferedImage#BufferedImage(int, int, int)}. Defaults to RGB with
