 ...
 * {@link Iterator} of properties with {@link
...
public class CascadedStyle {
    ...
    /**
     * Constructs a new CascadedStyle, given an {@link Iterator} of
    ...
    private void addProperties(Iterator iter) {
        ...
        for (int i = 0; i < buckets.length; i++) {
            for (Iterator it = buckets[i].iterator(); it.hasNext();) {
    ...
    /**
     * Returns an {@link Iterator} over the set of {@link
